...
public enum LogEvent {
    ...
    PTTG_AUDIT_HISTORY_BY_CORRELATION_ID_REQUEST_RECEIVED,
    PTTG_AUDIT_HISTORY_BY_CORRELATION_ID_RESPONSE_SUCCESS,
    ...
    PTTG_AUDIT_GET_IPS_STATS_REQUEST_RECEIVED,
    PTTG_AUDIT_GET_IPS_STATS_RESPONSE_SUCCESS,
    PTTG_AUDIT_GET_IPS_STATS_NOT_FOUND,
    PTTG_AUDIT_STORE_IPS_STATS_REQUEST_RECEIVED,
    PTTG_AUDIT_STORE_IPS_STATS_RESPONSE_SUCCESS,
    PTTG_AUDIT_IPS_STATS_ERROR;
